ready(function () {
  ...
  document.querySelector("#log").addEventListener("click", function (e) {
    ...
    //+ "&color=" + color.value + "&city" + city.value + "&food" + food.value + weapon.value + "&weapon" 
    //+ classtype.value + "&classtype" + supers.value + "&supers" + achievement.value + "&achievement" + type.value + "&type" + pet.value + "&pet"
