...
app.get("/userProfilePage.html", function (req, res) {
  ...
  if (req.session.loggedIn) {
    ...
    changeToJSDOM.window.document.getElementById("emailBox").placeholder = req.session.email;
    changeToJSDOM.window.document.getElementById("userPassword").placeholder = req.session.password;
...
app.post("/userProfilePage.html", function (req, res){
  ...
  Users.updateOne({ email: currentEmail }, {$set: {"email": req.body.emailBox}})
